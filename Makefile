...
cleanthesis:
	...
	-rm *.aux
	-rm $(TEXTDIR1)/*.{log,aux,toc,lof,lot,out,blg,bbl,pdf,xdv,fdb_latexmk,lb,synctex.gz}
	-rm $(TEXTDIR2)/*.{log,aux,toc,lof,lot,out,blg,bbl,pdf,xdv,fdb_latexmk,lb,synctex.gz}
